...
RSpec.describe Loadable do
  ...
  describe '.load_data' do
    ...
    context 'when loadable with from present' do
      ...
      let(:dummy_loadable_class) { Class.new(OpenStruct) {include Loadable; attr_accessor :field1, :field2; def valid?; end; def errors; end; def self.column_names; ['field1','field2'] end}}
