...
ActiveRecord::Schema.define(version: 20_190_718_182_216) do
  ...
  create_table 'agency_apartments', force: :cascade do |t|
    ...
    t.index %w[agency_id apartment_id], name: 'index_agency_apartments_on_agency_id_and_apartment_id', unique: true
  ...
  create_table 'apartments', force: :cascade do |t|
    ...
    t.index %w[address apartment city], name: 'index_apartments_on_address_and_apartment_and_city', unique: true
  end
